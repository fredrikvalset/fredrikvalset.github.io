...
export default class solarSystem {
  constructor(scene) {
    ...
    let earthNormalMap = new TextureLoader().load(
    ...
    radius = 2.5;
    let earthGeometry = new SphereGeometry(
      radius,
      widthSegments,
      heightSegment
    );
    ...
    let marsNormalMap = new TextureLoader().load(
      'assets/2k_earth_normal_map.png'
    );
    ...
    let mercuryNormalMap = new TextureLoader().load(
      'assets/2k_earth_normal_map.png'
    );
    ...
    let mercuryGeometry = new SphereGeometry(
      radius,
      widthSegments,
      heightSegment
    );
